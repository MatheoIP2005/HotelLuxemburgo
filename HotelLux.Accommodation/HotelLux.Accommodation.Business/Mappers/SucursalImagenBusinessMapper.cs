...
public static class SucursalImagenBusinessMapper
{
    public static SucursalImagenDTO ToDTO(SucursalImagenDataModel m) => new()
    {
    ...
    public static SucursalImagenDataModel ToDataModel(SucursalImagenCreateDTO dto, int idSucursal) => new()
    {
