...
[AllowAnonymous]
public class PublicReservasController : ControllerBase
{
    private readonly IReservaService _service;
    private readonly ILogger<PublicReservasController> _logger;

    public PublicReservasController(IReservaService service, ILogger<PublicReservasController> logger)
    {
        _service = service;
        _logger = logger;
    }
